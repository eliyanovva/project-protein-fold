...
def train(features, labels):
    ...
    clf=RandomForestClassifier(n_estimators=160, oob_score = True, min_samples_split = 640, min_samples_leaf = 79, min_impurity_decrease = 2, max_samples = None, max_leaf_nodes = None, max_features = 'sqrt', max_depth = None, bootstrap = True)
