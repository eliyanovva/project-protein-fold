...
#importing protein
filepath = "/Users/austin/Documents/ProteinFoldWork/project-protein-fold/data_files/pdb_data_files/AF-A0A0B4J1M2-F1-model_v2.pdb"
prefile = next(pybel.readfile("pdb", filepath))

#creating a Molecule object
protein = pybel.Molecule(prefile)
